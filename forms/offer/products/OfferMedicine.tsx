...
export const OfferMedicine: FC<IProps> = ({ counties, onSubmit, category }) => {
  const { t } = useTranslation()

  const othersSchema: SchemaOf<OfferMedicineForm> = yup.object().shape({
    county_coverage: yup
      .array()
  ...
  const onFormSubmit = (values: OfferMedicineForm) => {

    ...
    return (
        <>
            ...
            <div className="layout">
                <h1 className="mb-4 mt-4 text-3xl font-bold leading-normal md:max-w-[30ch]">
                ...
                <ul className="w-full py-5 md:w-1/2 md:px-3 md:py-0">
                    <li className="mb-3">
                        {t('cookie.policy.advice.p1.1')}
                    </li>
                    <li className="mb-3">
                        {t('cookie.policy.advice.p1.2')}
                    </li>
                    <li className="mb-3">
                        {t('cookie.policy.advice.p1.3')}
                    </li>
                </ul>
                ...
                <p className="mb-4">{t('cookie.policy.p10')}
